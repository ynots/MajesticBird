function AutoSuggest(textBox, engine, action) {
    "use strict";
    var t = this;
    var interval = null;
    var lastValue = "";
    ...
    t.getData = function (val) {
        ...
        /*
         chrome.history.search({text:val,maxResults:3},function(c){
         var history = _.pluck( c, "url" );
         history = _.sortBy(history,function(url){
         return url.length;
         })
         */
        {
                        ...
                        if (lastValue == val) {
                            ...
                            if (resultsLength == 0) {
                                ...
                                $(t.asDiv).css({
                                    ...
                                    'left': $('#search-input').offset().left + 52,
                                    'width': $('#search-input-area').width()
                                })
